 ...
 */
package com.mycompany.ejercicio4a3;
...
public class Principal extends javax.swing.JFrame {
    ...
    private void BtnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCalcularActionPerformed
        ...
        int Patrimonio = Integer.parseInt(TxtPat.getText());    
        byte Estrato = Byte.parseByte(TxtEstrato.getText());
        int Matricula = 50000;
        ...
        String a ="El estudiante de nombre "+Nombre+" y codigo "+Codigo+" debe pagar "+Matricula+" de matricula";
